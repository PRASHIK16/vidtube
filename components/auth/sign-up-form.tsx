  ...
  return (
    <div className="rounded-xl border bg-card p-8 shadow-sm space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Start sharing your videos</p>
      </div>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 rounded-md border border-input bg-background px-4 py-2.5 text-sm font-medium hover:bg-accent transition-colors disabled:opacity-50"
      >
